...
export default function SoftwareDevelopment() {
  return (
    <main className="w-full flex items-center justify-center px-10 py-8 md:py-16 lg:py-24">
      <div className="flex flex-col md:flex-row items-end md:items-center max-w-screen-lg">
        <div className="w-full md:w-2/4">
          ...
          <p className="font-body text-sm md:text-base lg:text-xl text-justify font-light">
            We turn your idea into an incremental digital product that will
            rapidly grow into the solution that you need.
          </p>
          <p className="py-5 text-sm md:text-base lg:text-xl text-justify font-medium">
            Why
          </p>
          <p className="font-body text-sm md:text-base lg:text-xl text-justify font-light">
